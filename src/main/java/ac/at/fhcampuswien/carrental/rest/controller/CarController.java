...
public class CarController {
    ...
    public ResponseEntity<List<Car>> listAvailableCars(@Valid @RequestHeader(value = "Auth") String token, @RequestParam("currency") String currency, @RequestParam("from") @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate from, @RequestParam("to") @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate to) {
